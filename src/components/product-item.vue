<template>
    ...
    <div class="product-item col-md-1-4 col-sm-1-3  col-xs-1-2 frow" @click="storeProduct">
        <router-link :to="{ name: 'product', params: { id: product.id, name: beautifyString(product.naziv) }}" class="product-item_inner">
            ...
            <div class="product-image">
                <img :src="'http://eterra.brainzined.com/storage/'+product.slika" :alt="product.naziv">
            </div>
