            ...
            <div class="links frow justify-between items-center">
                <div class="logo">
                    <router-link to="/" exact>
                        <img src="../images/eterra-logo-green.png" alt="">
                    </router-link>
                </div>

                <ul class="frow gutters nav-links" v-bind:class="{ open: navOpen }">
                    <!--<li class=""><router-link to="/" exact>Početna</router-link></li>-->
                    <li class=""><router-link to="/proizvodi">Proizvodi</router-link></li>
                    <li class=""><router-link to="/savet">Savet</router-link></li>
                    <li class=""><router-link to="/herbarijum">Herbarijum</router-link></li>
                    <li class=""><router-link to="/novosti">Novosti</router-link></li>
